...
export const deleteLeave = (id: string) => axiosInstance.delete(`/leaves/${id}`);
...
export const getMyLeaves = () => axiosInstance.get<LeaveResponse[]>("/leaves/my");
export const getAllLeaves = () => axiosInstance.get<LeaveResponse[]>("/leaves");
export const getPendingLeaves = () => axiosInstance.get<LeaveResponse[]>("/leaves/pending");
export const getMyNotifications = () => axiosInstance.get<LeaveResponse[]>("/leaves/notifications");
export const getMyBalance = () => axiosInstance.get<LeaveBalance[]>("/leaves/balance");
