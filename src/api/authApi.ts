...
export const login = (data: LoginRequest) => axiosInstance.post<AuthResponse>("/auth/login", data);
...
export const resetPasswordViaToken = (data: { token: string; password: string }) =>
