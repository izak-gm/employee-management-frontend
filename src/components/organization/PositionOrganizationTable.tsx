...
import {  type OrganizationRow } from "../../tables/department/departmentColumns";
import { positionColumns } from "../../tables/position/positionColumns";
    ...
    >
      <CardContent>
        <Stack spacing={3}>
          ...
          <DataGrid
            rows={filteredRows}
            columns={positionColumns(onEdit, onDelete)}
            loading={loading}
